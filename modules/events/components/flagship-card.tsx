    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="group relative w-full bg-[#111]/80 backdrop-blur-md rounded-[3rem] overflow-hidden cursor-pointer transition-all duration-500 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.8)] hover:border-[#2DD4BF]/40 hover:shadow-[0_0_60px_-10px_rgba(45,212,191,0.2)]"
                style={{
            ...
            >
                ...
                {/* Flagship badge */}
                <div className="absolute top-6 right-6 z-20 flex items-center gap-1.5 px-3 py-1.5 rounded-full backdrop-blur-sm border border-[#2DD4BF]/20 bg-[#2DD4BF]/10">
                ...
                <div className="relative z-10 flex flex-col lg:grid lg:grid-cols-[1fr_1.8fr] gap-0">
                    ...
                    {event.image && (
                        <div className="relative overflow-hidden bg-neutral-950/80 lg:rounded-tr-[2.5rem] p-2 min-h-[240px] lg:min-h-[420px] order-first lg:order-last">
                            <img
                                src={event.image}
                                alt={event.title}
                                loading="eager"
                                className="w-full h-full object-cover object-center rounded-xl group-hover:scale-[1.02] transition-transform duration-700"
                            />
                            {/* Fade overlay on left edge for desktop */}
                            <div className="absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#111] to-transparent pointer-events-none hidden lg:block" />
                        </div>
                    )}
