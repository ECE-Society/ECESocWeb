...
import { techathonRound1Results } from '@/modules/events/lib/techathon-results';

export default function TechathonResultsPage() {
    const [searchQuery, setSearchQuery] = useState('');

    const filteredResults = techathonRound1Results.filter((result) => {
        ...
        <main className="min-h-screen bg-[#080808] text-white pt-32 pb-24 px-4 sm:px-6 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                >
                    ...
                    <p className="text-[#a78bfa] font-bold uppercase tracking-[0.2em] mb-4">
                        Tech-A-Thon 5.0 • Quiz-A-Bit
                    </p>
                    <p className="text-neutral-400 max-w-2xl mx-auto">
                        Congratulations to all the teams that have successfully qualified for Round 2! The competition was fierce, and we are excited to see what you build in Tech-A-Bit.
                    </p>
                </motion.div>
                ...
                <div className="mt-12 text-center text-xs text-neutral-500 max-w-xl mx-auto">
                    <p>
                        Round 2 details have been sent to the registered email addresses of the team leaders. For any queries, please reach out to the organizing team.
                    </p>
                </div>
            </div>
        </main>
